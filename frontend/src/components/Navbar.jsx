    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium">
        <NavLink to={"/"}>
          ...
          <hr className="border-none outline-none h-0.5 bg-[#189d01] w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to={"/doctors"}>
      ...
      <div className="flex items-center gap-4">
        {token ? (
          ...
          <button
            ...
            className="bg-[#189d01] text-white px-8 py-3 rounded-full font-light hidden md:block"
          >
            Create Account
          </button>
        )}
